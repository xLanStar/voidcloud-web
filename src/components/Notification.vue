<script setup>
import { NotificationType, SVG_ICON_COLOR_PRIMARY, SVG_ICON_COLOR_SECONDARY } from '../reference';
...
<template>
    <div id="notification-container">
        <div class=notification  v-for="notification in notifications" :key="notification" :class="[{ show: notification.show }, notification.type]">
            <SvgIcon :icon="notification.icon || notification.type" :color="colorMap[notification.type]" />
